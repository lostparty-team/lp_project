        ...
        <footer className="bg-transparent text-gray-400 py-20 mt-auto">
          <div className="max-w-screen-xl mx-auto flex flex-col items-center justify-center">
            ...
            <div className="flex space-x-8 mb-4">
              <a href="#" className="text-m hover:text-gray-100">이용약관</a>
              <a href="#" className="text-m hover:text-gray-100">개인정보처리방침</a>
              <a href="#" className="text-m hover:text-gray-100">문의하기</a>
              <a href="#" className="text-m hover:text-gray-100">후원하기</a>
            </div>
            {/* 저작권 정보 */}
