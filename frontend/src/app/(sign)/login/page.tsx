      ...
      <div className="animate-fadeIn relative w-full max-w-md px-4 py-8">
        <div className="relative overflow-hidden rounded-lg border-2 border-lostark-400 bg-[#2a2a2a] p-8 shadow-2xl">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="tracking-wider text-2xl font-semibold text-lostark-400">로그인</h1>
          </div>
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full transform rounded-md border border-lostark-500 px-4 py-3 text-lostark-400 transition-all hover:border-lostark-400 outline-none"
            >
              로그인
            </button>
          </form>

          <div className="py-4 text-center gap- flex justify-between">
            <Link
              href="/registration"
